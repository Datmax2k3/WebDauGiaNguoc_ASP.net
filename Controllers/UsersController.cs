...
namespace WebDauGiaGiaNguoc.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(WebDauGiaGiaNguocContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,Username,UserPassword,Email,FullName,Address,PhoneNumber,Balance")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Username,UserPassword,Email,FullName,Address,PhoneNumber,Balance")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
