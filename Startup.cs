...
namespace WebDauGiaGiaNguoc
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<WebDauGiaGiaNguocContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("WebDauGiaGiaNguocContext")));
        }
